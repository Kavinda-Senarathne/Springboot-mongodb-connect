package hu.learnerbot.springboot.controller;

import hu.learnerbot.springboot.domain.Size;
import hu.learnerbot.springboot.domain.Stuff;
import hu.learnerbot.springboot.repository.StuffRepository;
...
public class StuffController
{
    ...
    public ModelAndView stuff(@RequestParam(name = "size", required = false) Size size)
    {
